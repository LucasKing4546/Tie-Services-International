...
const translations = {
  ro: {
    ...
    indexTvDescription: "TV cu ecran plat, aer condiționat, frigider, cuptor cu microunde și bucătărie complet utilată – totul pentru o ședere fără griji.",
    ...
    aboutConnectionDescription: 'Proprietarii nu au recepție fizică, dar comunică eficient înainte și în timpul sejurului – mesaj constant în recenzii .',
  ...
  en: {
    ...
    indexTvDescription: "Flat-screen TV, air conditioning, refrigerator, microwave, and fully equipped kitchen – all for a worry-free stay.",
    ...
    aboutConnectionDescription: 'The owners do not have a physical reception, but communicate effectively before and during the stay – constant message in reviews.',
  ...
  hu: {
    ...
    indexTvDescription: "Lapos képernyős TV, légkondicionáló, hűtőszekrény, mikrohullámú sütő és teljesen felszerelt konyha – minden a gondtalan tartózkodásért.",
    ...
    aboutConnectionDescription: 'A tulajdonosoknak nincs fizikai recepciójuk, de hatékonyan kommunikálnak a tartózkodás előtt és alatt – állandó üzenet a véleményekben.',
